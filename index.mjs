...
function buildJs() {
  ...
  js.push("var showThinking = true;");
  js.push("var showTools = true;");
  js.push("");
...
function buildListHtml(state) {
  ...
  lines.push('      <div class="drawer-tools"><button class="toggle-btn active" id="btnThinking" aria-pressed="true">\u{1F9E0} \u601D\u8003</button><button class="toggle-btn active" id="btnTools" aria-pressed="true">\u{1F527} \u5DE5\u5177</button></div>');
