...
var MARKDOWN_CSS = [
  ...
  ".activity{background:#f8f7f4;border:1px solid #e8e3da;border-radius:12px;padding:12px 14px;line-height:1.65;font-size:14px;color:var(--ink);box-shadow:0 1px 3px rgba(37,36,33,.04)}",
