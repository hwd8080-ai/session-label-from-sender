...
function buildListHtml(state) {
  ...
  lines.push('      <button type="button" class="fab-item fab-tool" id="btnThinkingFab" aria-pressed="false" data-tip="\u601D\u8003">\u{1F9E0}</button>');
  lines.push('      <button type="button" class="fab-item fab-tool" id="btnToolsFab" aria-pressed="false" data-tip="\u5DE5\u5177">\u{1F527}</button>');
  lines.push('      <button type="button" class="fab-item" id="jumpTopFab" aria-label="\u5230\u6700\u65E9\u7684\u6D88\u606F" data-tip="\u9876\u90E8">\u25B2</button>');
  lines.push('      <button type="button" class="fab-item" id="fabCopyFab" aria-label="\u590D\u5236\u5168\u6587\u5230\u526A\u8D34\u677F" data-tip="\u590D\u5236\u5168\u6587">\u2197</button>');
  lines.push('      <button type="button" class="fab-item fab-toggle" id="fabToggle" aria-label="\u5C55\u5F00\u5FEB\u6377\u64CD\u4F5C" aria-expanded="false">\u22EE</button>');
  lines.push("    </div>");
