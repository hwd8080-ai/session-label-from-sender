...
function buildJs() {
  ...
  js.push("  if (dsc) dsc.style.display = (ds && ds.value) ? 'inline-flex' : 'none';");
  js.push("  if (dec) dec.style.display = (de && de.value) ? 'inline-flex' : 'none';");
  js.push("}");
...
function buildListHtml(state) {
  ...
  lines.push('      <div class="msg-search"><div class="search-wrap"><input type="search" id="msgSearch" placeholder="\u641C\u7D22\u6D88\u606F\u5173\u952E\u5B57\u2026"><button type="button" class="search-inside-clear" id="searchInputClear" aria-label="\u6E05\u9664\u641C\u7D22" style="display:none">\xD7</button></div><span class="search-count" id="searchCount"></span></div>');
  lines.push("    </div>");
