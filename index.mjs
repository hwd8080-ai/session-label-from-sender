...
function buildJs() {
  ...
  js.push("  var box = $('messages');");
  js.push("  if (!q) {");
  js.push("    msgHighlight = null; count.textContent = ''; currentMatchIdx = -1;");
...
function buildListHtml(state) {
  ...
  lines.push('      <div class="msg-search"><input type="search" id="msgSearch" placeholder="\u641C\u7D22\u6D88\u606F\u5173\u952E\u5B57\u2026"><span class="search-count" id="searchCount"></span><button class="date-clear" id="dateClear" style="display:none" aria-label="\u6E05\u9664\u65E5\u671F">\u232B \u6E05\u7A7A</button></div>');
  lines.push("    </div>");
