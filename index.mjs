...
function buildJs() {
  ...
  js.push("  var box = $('messages'); if (!box) return;");
  js.push("  box.classList.toggle('hide-thinking', !showThinking);");
  js.push("  box.classList.toggle('hide-tools', !showTools);");
  ...
  js.push("  var ds = $('dStart'), de = $('dEnd'); if (ds) ds.value = ''; if (de) de.value = ''; var dclr = $('dateClear'); if (dclr) dclr.style.display = 'none';");
  ...
  js.push("  var sd = $('dStart').value, ed = $('dEnd').value;");
  js.push("  var dclr = $('dateClear');");
  js.push("  if (sd && ed && sd > ed) { showToast('\u5F00\u59CB\u65E5\u671F\u4E0D\u80FD\u665A\u4E8E\u7ED3\u675F\u65E5\u671F'); return; }");
  js.push("  dclr.style.display = (sd || ed) ? 'inline-flex' : 'none';");
  js.push("  msgMode = 'desc'; msgAllLoaded = false; oldestSeq = null; newestSeq = null; msgOffset = 0; currentMessages = []; topDate = null; bottomDate = null;");
...
function buildListHtml(state) {
  ...
  lines.push('      <div class="drawer-dates"><div class="range"><input id="dStart" class="control" type="date" aria-label="\u5F00\u59CB\u65E5\u671F"><span>\u81F3</span><input id="dEnd" class="control" type="date" aria-label="\u7ED3\u675F\u65E5\u671F"></div></div>');
  lines.push('      <div class="drawer-tools"><button type="button" class="toggle-btn" id="btnThinking" aria-pressed="false">\u{1F9E0} \u601D\u8003</button><button type="button" class="toggle-btn" id="btnTools" aria-pressed="false">\u{1F527} \u5DE5\u5177</button><button class="date-clear" id="dateClear" style="display:none" aria-label="\u6E05\u9664\u65E5\u671F">\u232B \u6E05\u7A7A</button></div>');
  lines.push("    </header>");
  lines.push('    <div class="meta" id="meta"></div>');
  lines.push('    <div class="drawer-search"><input type="search" id="msgSearch" placeholder="\u641C\u7D22\u6D88\u606F\u5173\u952E\u5B57\u2026"><span class="search-count" id="searchCount"></span><button class="search-clear" id="searchClear" style="display:none">\u2715</button></div>');
  lines.push('    <div class="jump-nav" aria-label="\u6D88\u606F\u8DF3\u8F6C">');
  lines.push('      <button type="button" class="jump-btn" id="jumpTop" aria-label="\u5230\u6700\u65E9\u7684\u6D88\u606F">\u25B2 \u9876\u90E8</button>');
  lines.push("    </div>");
  lines.push('    <div class="messages" id="messages"></div>');
  lines.push('    <button type="button" class="fab" id="fabCopy" aria-label="\u590D\u5236\u5168\u6587\u5230\u526A\u8D34\u677F">\u2197 \u590D\u5236\u5168\u6587</button>');
  lines.push("  </aside>");
  lines.push("</div>");
  lines.push("");
  lines.push("<script>");
