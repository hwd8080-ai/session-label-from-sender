...
function buildListHtml(state) {
  ...
  lines.push('      <button type="button" class="fab-item fab-tool below" id="btnThinkingFab" aria-pressed="false" data-tip="\u601D\u8003" style="order:4">\u{1F9E0}</button>');
  lines.push('      <button type="button" class="fab-item fab-tool above" id="btnToolsFab" aria-pressed="false" data-tip="\u5DE5\u5177" style="order:2">\u{1F527}</button>');
