...
function buildListHtml(state) {
  ...
  lines.push("      <div class=\"drawer-tools\"><button type=\"button\" class=\"toggle-btn\" id=\"btnThinking\" aria-pressed=\"false\">🧠 思考</button><button type=\"button\" class=\"toggle-btn\" id=\"btnTools\" aria-pressed=\"false\">🔧 工具</button></div>");
  lines.push("      <button type=\"button\" class=\"close\" id=\"closeBtn\" aria-label=\"关闭\">×</button>");
  lines.push("    </header>");
