...
function buildListHtml(state) {
  ...
  lines.push("      <button type=\"button\" class=\"fab-item fab-tool\" id=\"btnThinkingFab\" aria-pressed=\"false\" data-tip=\"思考\">🧠</button>");
  lines.push("      <button type=\"button\" class=\"fab-item fab-tool\" id=\"btnToolsFab\" aria-pressed=\"false\" data-tip=\"工具\">🔧</button>");
