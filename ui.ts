...
function buildListHtml(state) {
  ...
  lines.push("      <div class=\"drawer-tools\"><button class=\"toggle-btn\" id=\"btnThinking\" aria-pressed=\"false\">🧠 思考</button><button class=\"toggle-btn\" id=\"btnTools\" aria-pressed=\"false\">🔧 工具</button></div>");
