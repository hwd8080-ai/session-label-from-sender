...
function buildListHtml(state) {
  ...
  lines.push("      <div class=\"drawer-tools\"><button type=\"button\" class=\"toggle-btn\" id=\"btnThinking\" aria-pressed=\"false\">🧠 思考</button><button type=\"button\" class=\"toggle-btn\" id=\"btnTools\" aria-pressed=\"false\">🔧 工具</button><button class=\"date-clear\" id=\"dateClear\" style=\"display:none\" aria-label=\"清除日期\">⌫ 清空</button></div>");
  lines.push("    </header>");
