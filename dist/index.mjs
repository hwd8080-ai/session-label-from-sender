...
.date-clear-slot{flex:none;width:24px;min-width:24px;height:34px;display:inline-flex;align-items:center;justify-content:center}
.drawer-dates .search-clear{width:22px;height:22px;border-radius:50%;background:#efeae2;color:#8a8479;border:none;font-size:13px;line-height:1;display:inline-flex;align-items:center;justify-content:center;padding:0}
.drawer-dates .search-clear:hover{background:#e2dcd1;color:#5e5a53}
...
function buildListHtml(state) {
  ...
  lines.push('      <div class="drawer-dates"><div class="range"><input id="dStart" class="control" type="date" aria-label="\u5F00\u59CB\u65E5\u671F"><span>\u81F3</span><input id="dEnd" class="control" type="date" aria-label="\u7ED3\u675F\u65E5\u671F"></div><span class="date-clear-slot"><button class="search-clear" id="dateClear" style="display:none" aria-label="\u6E05\u9664\u65E5\u671F">\u2715</button></span></div>');
