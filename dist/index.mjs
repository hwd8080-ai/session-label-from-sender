...
function buildJs() {
  ...
  js.push("  var html = '';");
  js.push("  var lastDate = startLastDate;");
  ...
  js.push("  });");
  js.push("  return { html: html, lastDate: lastDate };");
  js.push("}");
  ...
  js.push("        var fd = box.querySelector('.date-divider');");
  js.push("        if (fd) fd.insertAdjacentHTML('beforebegin', bb.html);");
  js.push("        else { var mt = document.getElementById('msgTop'); if (mt) mt.insertAdjacentHTML('afterend', bb.html); else box.insertAdjacentHTML('afterbegin', bb.html); }");
