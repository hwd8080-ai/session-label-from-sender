...
function buildListHtml(state) {
  ...
  lines.push('      <div class="drawer-dates"><div class="range"><input id="dStart" class="control" type="date" aria-label="\u5F00\u59CB\u65E5\u671F"><span>\u81F3</span><input id="dEnd" class="control" type="date" aria-label="\u7ED3\u675F\u65E5\u671F"></div><button class="search-clear" id="dateClear" style="display:none" aria-label="\u6E05\u9664\u65E5\u671F">\u2715</button></div>');
  lines.push('      <div class="drawer-tools"><button class="toggle-btn" id="btnThinking" aria-pressed="false">\u{1F9E0} \u601D\u8003</button><button class="toggle-btn" id="btnTools" aria-pressed="false">\u{1F527} \u5DE5\u5177</button></div>');
