...
function renderItemTs(item) {
  ...
  return '<article class="message bot activity" data-type="tool" data-act="' + escHtml(String(item.msgs[0].seq)) + '"><div class="mavatar">\u2699\uFE0F</div><div class="mbody"><div class="mmeta"><strong>Activity</strong><span>' + timeStr + "</span></div>" + card + "</div></article>";
}
