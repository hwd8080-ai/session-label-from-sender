...
// ../session-label-from-sender/index.ts
import { definePluginEntry } from "openclaw/plugin-sdk/plugin-entry";
import path4 from "node:path";
import fs4 from "node:fs";
import { fileURLToPath as fileURLToPath2 } from "node:url";

// ../session-label-from-sender/db.ts
...
// ../session-label-from-sender/sync.ts
...
// ../session-label-from-sender/ui.ts
...
function buildJs() {
  ...
  js.push("  if (sd && ed && sd > ed) { $('drawerDateError').textContent = '\u5F00\u59CB\u65E5\u671F\u4E0D\u80FD\u665A\u4E8E\u7ED3\u675F\u65E5\u671F'; $('drawerDateError').style.display = 'block'; return; }");
  js.push("  $('drawerDateError').style.display = 'none';");
...
function buildListHtml(state) {
  ...
  lines.push('        <div class="error-banner inline" id="errorBox" style="display:none"></div>');
  lines.push("      </div>");
  ...
  lines.push('      <div class="drawer-dates"><div class="range"><input id="dStart" class="control" type="date" aria-label="\u5F00\u59CB\u65E5\u671F"><span>\u81F3</span><input id="dEnd" class="control" type="date" aria-label="\u7ED3\u675F\u65E5\u671F"></div><span class="date-clear-slot"><button class="date-clear" id="dateClear" style="display:none" aria-label="\u6E05\u9664\u65E5\u671F">\u232B \u6E05\u7A7A</button></span></div>');
  lines.push('      <div class="drawer-tools"><button type="button" class="toggle-btn" id="btnThinking" aria-pressed="false">\u{1F9E0} \u601D\u8003</button><button type="button" class="toggle-btn" id="btnTools" aria-pressed="false">\u{1F527} \u5DE5\u5177</button></div>');
  lines.push('      <button type="button" class="close" id="closeBtn" aria-label="\u5173\u95ED">\xD7</button>');
  lines.push("    </header>");
  lines.push('    <div class="drawer-date-error" id="drawerDateError" style="display:none"></div>');
